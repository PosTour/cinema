...
//        ticketRepository.deleteTicketByBookingCode(bCode);
    ...
    @Override
    public void deleteTicket(TicketClientDto ticketClientDto) {
        TicketUpdateDto ticketUpdateDto = new TicketUpdateDto(ticketClientDto.bookingCode(), ticketClientDto.chatId(), "deleted");

        ticketRepository.deleteTicket(ticketClientDto.chatId(), ticketClientDto.sessionId(), ticketClientDto.placeId());
    }
}