...
-- changeset Admin:1720706671059-1
CREATE TABLE hall
(
    id    UUID         NOT NULL,
...
-- changeset Admin:1720706671059-2
CREATE TABLE movie
(
    id          UUID        NOT NULL,
...
-- changeset Admin:1720706671059-3
CREATE TABLE place
(
    id           UUID    NOT NULL,
...
-- changeset Admin:1720706671059-4
CREATE TABLE row
(
    id         UUID    NOT NULL,
...
-- changeset Admin:1720706671059-5
...
-- changeset Admin:1720706671059-6
CREATE TABLE ticket
(
    id           UUID         NOT NULL,
    user_chat_id UUID,
...
-- changeset Admin:1720706671059-7
