...
-- changeset Admin:1720682973913-1
CREATE TABLE hall
(
    id    UUID         NOT NULL,
...
-- changeset Admin:1720682973913-2
CREATE TABLE movie
(
    id          UUID        NOT NULL,
...
-- changeset Admin:1720682973913-3
CREATE TABLE place
(
    id           UUID    NOT NULL,
...
-- changeset Admin:1720682973913-4
CREATE TABLE row
(
    id         UUID    NOT NULL,
...
-- changeset Admin:1720682973913-5
...
-- changeset Admin:1720682973913-6
CREATE TABLE ticket
(
    id           UUID         NOT NULL,
    user_id      UUID,
...
-- changeset Admin:1720682973913-7
CREATE TABLE "user"
(
    id      UUID        NOT NULL,
