...
-- changeset Admin:1720525242521-1
CREATE TABLE hall
(
    id       UUID         NOT NULL,
...
-- changeset Admin:1720525242521-2
CREATE TABLE movie
(
    id          UUID        NOT NULL,
...
-- changeset Admin:1720525242521-3
CREATE TABLE place
(
    id          UUID    NOT NULL,
...
-- changeset Admin:1720525242521-4
CREATE TABLE row
(
    id            UUID NOT NULL,
...
-- changeset Admin:1720525242521-5
...
-- changeset Admin:1720525242521-6
CREATE TABLE ticket
(
    id         UUID NOT NULL,
    user_id    UUID,
...
-- changeset Admin:1720525242521-7
CREATE TABLE "user"
(
    id    UUID        NOT NULL,
