...
-- changeset Admin:1720621902298-1
CREATE TABLE hall
(
    id    UUID         NOT NULL,
...
-- changeset Admin:1720621902298-2
CREATE TABLE movie
(
    id          UUID        NOT NULL,
...
-- changeset Admin:1720621902298-3
CREATE TABLE place
(
    id           UUID    NOT NULL,
...
-- changeset Admin:1720621902298-4
CREATE TABLE row
(
    id         UUID    NOT NULL,
...
-- changeset Admin:1720621902298-5
...
-- changeset Admin:1720621902298-6
CREATE TABLE ticket
(
    id         UUID NOT NULL,
    user_id    UUID,
...
-- changeset Admin:1720621902298-7
CREATE TABLE "user"
(
    id      UUID        NOT NULL,
